...
## About
Kocom Wallpad with RS485 for 거의푸르지오엘리포레시티

## Installation

1. 홈어시스턴트의 Hass.io > ADD-ON STORE에서 Add new repository by URL에 https://github.com/asata/kocom.py 를 입력한 다음 ADD 버튼을 누릅니다.
...
7. share/kocom/ 또는 /mnt/data/supervisor/share/kocom/ 폴더에 있는 kocom.conf 파일을 본인의 환경에 맞게 수정합니다.
8. "START" 버튼으로 애드온을 실행합니다.

만일 kocom.py 파일을 수정하시려면 해당 repository를 본인 계정에 fork 후 수정하신 다음에
애드온을 재 설치 해야 합니다

## 거의푸르지오엘리포레시티 제어 가능 기기 목록
- 조명
- 난방
- 전열교환기 (CO2 측정값 조회)
- 엘리베이터 호출
...
- ~~에어컨~~ : **제어 불가**
	+ 에어컨 제어 다른 방법으로 처
		* 실내기에 M5Stack + RS485 장치 추가
		* https://github.com/omerfaruk-aran/esphome_samsung_hvac_bus

-------------------------------------------------------------------------------------

## Change log
(2025-10-00 asata 수정) 방이 4개인 경우 처리 추가 (A타입), 불필요한 센서 제거

(2025-10-17 asata 수정) 전열교환기(Fan) 프리셋 모드 테스트, 기능 미적용

(2025-09-11 asata 수정) 전열교환기(Fan) CO2 측정값 반환 추가, 난방 최저 설정 온도 제한 변경

(2024-12-07 asata 수정) 실행 오류 수정
